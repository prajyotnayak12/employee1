...
class Program
{
    static void Main(string[] args)
    {
        ...
        {
            new Employee(1, "Manash", "Jd", 50000, new DateTime(2024, 4, 15)),
            new Employee(2, "Rajat", "SD", 60000, new DateTime(2024, 4, 20)),
            new Employee(3, "Ashutosh", "JD", 55000, new DateTime(2024, 4, 10)),
            new Employee(4, "Rakesh", "SALE", 48000, new DateTime(2024, 4, 5)),
            new Employee(5, "Saloni", "JD", 52000, new DateTime(2024, 4, 12))
        };
    ...
    static void PrintEmployeeList(List<Employee> employees)
    {
        ...
        UpdateEmployeePositionAndSalary(employeeWithLowestSalary, "SA", 55000);
